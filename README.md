...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-17 11:09`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8ea75c4c-df5b-460c-99cb-633fbc08a252.git
$ cd 8ea75c4c-df5b-460c-99cb-633fbc08a252
```
